...
erDiagram
    ...
    OBSERVER }|--|{ CELESTIAL-OBJECT : observes
    OBSERVER }|--|{ EVENT : observes
...
| object_id | object_name      | object_type  | RA         | Dec               | magnitude | description                                |
|-----------|------------------|--------------|------------|-------------------|-----------|--------------------------------------------|
| 1         | andromeda galaxy | galaxy       | 00h 42m 44s | +41° 16' 09"     | 3.44      | Spiral galaxy visible to the naked eye.   |
| 2         | orion nebula    | nebula        | 05h 35m 17s | -05° 23' 28"     | 4.00      | Emission nebula in the Orion constellation. |
| 3         | jupiter         | planet        | 20h 22m 38s | -18° 40' 48"     | -2.94     | The largest planet in our solar system.    |
| 4         | pleiades        | star cluster  | 03h 47m 24s | +24° 07' 00"     | 1.60      | Open star cluster in Taurus constellation.  |
| 5         | horsehead nebula | nebula        | 05h 41m 02s | -02° 27' 30"     | 6.80      | Dark nebula in the constellation Orion.    |
...
| location_id | hemisphere | latitude  | longitude  |
|------------|------------|-----------|------------|
| 1          | Northern    | 40.7128   | -74.0060   |
| 2          | Southern    | 34.0522   | -118.2437  |
| 3          | Northern    | 51.5074   | -0.1278    |
| 4          | Southern    | 33.4484   | -112.0740  |
| 5          | Northern    | 41.8781   | -87.6298   |
